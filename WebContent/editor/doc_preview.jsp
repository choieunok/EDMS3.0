		...
		<div id="tx_trex_container" class="tx-editor-container">
			...
			<div id="tx_toolbar_basic" class="tx-toolbar tx-toolbar-basic" style="display:none;"><div class="tx-toolbar-boundary">
				<ul class="tx-bar tx-bar-left">
					<li class="tx-list">
						<div id="tx_fontfamily" unselectable="on" class="tx-slt-42bg tx-fontfamily">
...
<script type="text/javascript">
	...
	EditorJSLoader.ready(function(Editor) {
		...
		Editor.getCanvas().setCanvasSize({height:117});
	});
...
<script type="text/javascript">
	...
	function loadContent() {		
		// 쓰기가 아닌 경우만 수행
		Editor.modify({			
			"content": parent.document.getElementById("preview_content").value
		});
	}
	...
	/*********************************************************
	* 폰트종류변경 : fontfamily.js
	* 폰트사이즈변경 : fontsize.js
	* 폰트종류/폰트사이즈 레이어 크기 조정 : tool.css
	***********************************************************/
