...
<div class="cnt_wrapper">		
	<jsp:include page="/jsp/layout/statisticsMenu.jsp" />	  
		<div class="contents">
			...
			<div class="cnts_tbl_menu">
				...
				<div class="tbl_menu_right">
					<ul class="tbl_thumbMenu">
						...
						<li class="excel_download"><a href="javascript:void(0);" class="menu" onClick="javascript:exsoft.util.grid.excelDown('loginLogGridList','${contextRoot}/statistics/loginLogList.do');"></a></li>
						<li class="menu_refresh"><a href="javascript:void(0);" class="menu" onclick="javascript:exsoft.util.grid.gridRefresh('loginLogGridList','${contextRoot}/statistics/loginLogList.do')"></a></li>
					</ul>
			...
			<div class="cnts_tbl_wrapper" id="targetLoginGridcontainer">                 
				<div class="cnts_list"><table id="loginLogGridList"></table></div>					
			</div>
...
jQuery(function() {	  	 
	  ...
	  exsoftStatisticsFunc.init.initPage("${menuType}","loginStatistics",'statisticsPageTitle','${pageSize}','${part}','#loginLogGridList','/statistics/loginLogList.do');
	  exsoftStatisticsFunc.event.loginLogGridList();
	  exsoft.util.grid.gridResize('loginLogGridList','targetLoginGridcontainer',50,0);	  
