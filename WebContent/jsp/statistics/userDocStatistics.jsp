...
<div class="cnt_wrapper">		
	<jsp:include page="/jsp/layout/statisticsMenu.jsp" />	  
		<div class="contents">
			...
			<div class="cnts_tbl_menu">
				...
				<div class="tbl_menu_right">
					<ul class="tbl_thumbMenu">						
						<li class="excel_download"><a href="javascript:void(0);" class="menu" onClick="javascript:exsoft.util.grid.excelDown('userDocGridList','${contextRoot}/statistics/userDocGridList.do');"></a></li>
						<li class="menu_refresh"><a href="javascript:void(0);" class="menu" onclick="javascript:exsoft.util.grid.gridRefresh('userDocGridList','${contextRoot}/statistics/userDocGridList.do')"></a></li>
					</ul>
			...
			<div class="cnts_tbl_wrapper" id="targetUserDocGridcontainer">
				<div class="cnts_list"><table id="userDocGridList"></table></div>		
			</div>
			<div class="pg_navi_wrapper">
				<ul id="userDocGridPager" class="pg_navi"></ul>
			</div>
	</div>
</div>
...
<script type="text/javascript">
 jQuery(function() {	  	 
  ...
  exsoftStatisticsFunc.init.initPage("${menuType}","userDocStatistics",'statisticsPageTitle','${pageSize}','${part}','#userDocGridList','/statistics/userDocGridList.do');
  exsoftStatisticsFunc.event.userDocGridList();
  exsoft.util.grid.gridResize('userDocGridList','targetUserDocGridcontainer',50,0);
 });
