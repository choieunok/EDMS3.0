				...
				<div class="cnts_srch_detail">
					<div class="cnts_srch">
						<div class="cnts_srch_group">
							...
							<input type="text" class="srch_keyword" name="statisticsKeyword" id="statisticsKeyword" placeholder="검색어를 입력하세요" maxlength="20" 
							onkeydown="javascript:if(event.keyCode == 13) { exsoftStatisticsFunc.event.searchQuotaFunc(); return false;}">
