			...
			<div class="cnts_tbl_menu">
				...
				<div class="tbl_menu_right">
					<ul class="tbl_thumbMenu">
						...
						<li class="excel_download"><a href="javascript:void(0);" class="menu" onClick="javascript:exsoft.util.grid.excelDown('userFolderGridList','${contextRoot}/statistics/userFolderStatisticsList.do');"></a></li>
						<li class="menu_refresh"><a href="javascript:void(0);" class="menu" onclick="javascript:exsoft.util.grid.gridRefresh('userFolderGridList','${contextRoot}/statistics/userFolderStatisticsList.do')"></a></li>
					</ul>
