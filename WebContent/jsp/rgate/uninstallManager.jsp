	...
	<div class="rGateConfig_sub_wrapper">
		<div class="rGate_config_info">
			<div class="config_info_btnGrp">
				<button type="button" id="" name="" class="btn1">전사 추가</button>
				<button type="button" id="" name="" class="btn1">부서/사용자 추가</button>
				<button type="button" id="" name="" class="btn1" onclick="javascript:exsoftAdminRgateFunc.open.configPasswd();">정책 수정</button>
				<button type="button" id="" name="" class="btn1">정책 삭제</button>
			</div>
...
<!-- 삭제 비밀번호 설정 시작 -->
<div class="rGate_setPwd_wrapper hide"></div>
<div class="rGate_setPwd hide">
	<div class="window_title">
		삭제 비밀번호 설정
        <a href="#" class="window_close"><img src="/img/icon/window_close.png" alt="" title=""></a>
    </div>
    <div class="rGate_setPwd_cnts">
    	<div class="setPwd_cnts_subWrapper">
    		<form id="">
    			<label>
    				삭제 비밀번호
...
jQuery(function() {	
	...
	exsoft.util.layout.lyrPopupWindowResize($(".rGate_setPwd"));
	...
	// 비밀번호 설정
	$('.rGate_setPwd_wrapper').bind("click", function(){
	    	$(this).addClass('hide');
	    	$('.rGate_setPwd').addClass('hide');
	});
