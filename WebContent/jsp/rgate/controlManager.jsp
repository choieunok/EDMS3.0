 ...
 <div class="cnt_wrapper">
	...
	<div class="rGateConfig_sub_wrapper">
		<div class="rGate_config_info">
			<div>
				<button type="button" id="" name="" class="local_add_btn btn1 ">전사 추가</button>
				<button type="button" id="" name="" class="local_deptUser_btn btn1 " onclick="javascript:exsoftAdminRgateFunc.open.addGroupWrite();" >부서/사용자 추가</button>
