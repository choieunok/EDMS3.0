	...
	<div class="contents">
		<div class="cnts_srch_wrapper">
			...
			<div class="cnts_srch_detail">
				...
				<div id="workDocListNoty" style="display:inline-block;padding:8px 18px 8px 18px;"></div>
			</div>
		...
		<div class="cnts_tbl_menu">
			<div class="tbl_menu_left">
				<button type="button" class="tbl_reg" onclick="workDocList.event.docWritePopup();">등록</button>
				...
				<div class="tbl_extFunction">
					...
					<div class="extFunction_dropDown_wrapper hide">
						<ul class="extFunction_dropDown_menu">
							...
							<li><a href="#" class="tempbox" onclick="documentListLayerWindow.event.documentReadRequest();">열람요청</a></li>
						</ul>
					</div>
				</div>
			</div>
			<div class="tbl_menu_right">
				<ul class="tbl_thumbMenu">
					<li class="excel_download"><a href="javascript:void(0);" class="menu" onclick="javascript:exsoft.util.grid.excelDown('workDocList','${contextRoot}/document/workDocumentList.do')"></a></li>
					...
					<li class="menu_refresh"><a href="javascript:void(0);" class="menu" onclick="javascript:exsoft.util.grid.gridRefresh('workDocList','${contextRoot}/document/workDocumentList.do')"></a></li>
				</ul>
...
jQuery(function() {
	//page 초기화
	workDocList.init.initPage("${pageSize}","${menuType}");
