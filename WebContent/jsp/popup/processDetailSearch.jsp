...
<div class="srch_detail_dropDown">
	<a class="dropDown_txt"><label>상세</label><span class="dropDown_arrow down"></span></a>
	...
	<form id="frm_docListLayer_detail_search" name="frm_docListLayer_detail_search">
		...
		<tr>
			<td colspan="2" class="srch_detail_btnGrp">
				<button type="button" class="srch_detail_btn" onClick='javascript:processDetailSearch.event.search();'>검색</button>
				<button type="button" class="srch_detail_btn" onClick='javascript:processDetailSearch.event.processDetailSearchInit("frm_docListLayer_detail_search");'>초기화</button>
			</td>
		</tr>
		</table>
...
<!-- script add -->
<script type="text/javascript" src="${contextRoot}/js/popup/processDetailSearch.js"></script>
<script type="text/javascript">
jQuery(function() {
	processDetailSearch.init.initPage();
});
</script>